...
export default function OncePopup() {
  ...
  useEffect(() => {
    ...
    const alreadyClosed = localStorage.getItem(POPUP_STORAGE_KEY);

    // আগে কখনও close করে নি → popup open হবে
    if (!alreadyClosed) {
      setIsOpen(true);
    }
  }, []);
...
<p className="mb-6 text-base text-slate-700 leading-relaxed space-y-4">
  <span className="block">
    আমাদের ভার্সিটির সব ডিপার্টমেন্টের ছেলেমেয়েরা এই সাইট থেকে অ্যাসাইনমেন্ট ও ল্যাব রিপোর্টের কভার পেজ প্রিন্ট করে। 
    এখন দেখা যাচ্ছে প্রতি ডিপার্টমেন্ট আলাদা আলাদা টেমপ্লেট ব্যবহার করছে — তাই আমরা চাই আরও বেশি সুন্দর টেমপ্লেট যোগ করতে।
  </span>
  ...
  <span className="block">
    নিজের বানানো কোনো কভার পেজ থাকলে শেয়ার করো — তোমার নাম দিয়ে আমরা সেটা টেমপ্লেট হিসেবে যোগ করে দিব। 🔥
  </span>

  <span className="block bg-indigo-50 px-4 py-3 rounded-lg font-medium text-indigo-800">
    করণীয়:<br />
    → ডিজাইন ফাইল Google Drive-এ আপলোড করে লিঙ্ক কপি করো<br />
    → Feedback পেজে নাম + ইমেইল + লিঙ্ক পাঠিয়ে দাও<br />
