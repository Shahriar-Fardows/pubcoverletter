...
const FeedbackForm: React.FC<FeedbackFormProps> = ({ initialChallenge }) => {
  const [challenge, setChallenge] = useState<Challenge>(initialChallenge);

  const handleRefreshChallenge = () => {
    // client-side e notun math challenge generate
  ...
  return (
    <div className="w-full max-w-3xl p-8">
      <h1 className="text-2xl font-semibold text-black mb-2">Feedback</h1>
